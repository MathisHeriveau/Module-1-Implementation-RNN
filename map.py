# -*- coding: utf-8 -*-
"""
Created on Tue Nov  5 15:54:53 2024
...
def init():
    ...
    global goal_y
    global first_update
    sand = numpy.zeros((longueur,largeur))
    goal_x = 20
    goal_y = largeur - 20
    first_update = False
...
class Car(Widget):
    ...
    # Initializing the velocity of the car
    ...
    def move(self, rotation):
        ...
        # Checking for the boundaries of the map
...
class Game(Widget):
        ...
        def update(self, dt):
            ...
            if distance < 100:
                ...
                print("widht :" , self.width , " heigh :" , self.height)
